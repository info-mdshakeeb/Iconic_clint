import { getAuth, GoogleAuthProvider, onAuthStateChanged, signInWithEmailAndPassword, signInWithPopup, updateProfile } from "firebase/auth";
...
const UserContext = ({ children }) => {
    ...
    const authInfo = {
        user, setUser,
        loading, setLoading,
        GoogleLogin, loginEmail, signOut,
        updateProfilePic
    }
    return (
